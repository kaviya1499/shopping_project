...
.ch-item:hover .ch-info {
   ...
   <body>
                  ...
                  <div class="carousel-item">
                     <div class="container">
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div><img src="images/ban2.webp" class="image_1"></div>
                           </div>
                        </div>
                        <div class="button_main"><button class="all_text">All</button><input type="text" class="Enter_text" placeholder="Enter keywords" name=""><button class="search_text">Search</button></div>
                     </div>
                  ...
                  <div class="carousel-item">
                     <div class="container">
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div><img src="images/banner3.png" class="image_1"></div>
                           </div>
                        </div>
                        <div class="button_main"><button class="all_text">All</button><input type="text" class="Enter_text" placeholder="Enter keywords" name=""><button class="search_text">Search</button></div>
                     </div>
      ...
      <h1 style="font-size:50px;text-align:center">Top Categories</h1>
   <ul class="ch-grid">
	<li>
		<div class="ch-item ch-img-1">
			<div class="ch-info">
				<h3>Fashion & Beauty</h3>
				<p> <a href="fashion_product.jsp">View More</a></p>
			</div>
		</div>
	</li>
	<li>
		<div class="ch-item ch-img-2">
			<div class="ch-info">
				<h3>Mobiles & Electronic Devices</h3>
				<p> <a href="http://drbl.in/eKMi">View More</a></p>
			</div>
		</div>
	</li>
	<li>
	...
	<li>
		<div class="ch-item ch-img-4">
			<div class="ch-info">
				...
				<p><a href="http://drbl.in/ekhp">View More</a></p>
			</div>
		</div>
	</li>
	...
	<li>
      ...
      <div class="newsletter_section layout_padding">
         <div class="container">
            <h6 class="conect_text">Connect to community</h6>
            <h1 class="newsletter_taital">Join Our Isha Website</h1>
