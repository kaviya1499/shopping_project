...
figure.snip1249:before {
  background-color: #8440e0c4;
  -webkit-transform: skew(-45deg) translateX(-150%);
  transform: skew(-45deg) translateX(-150%);
  border-right: 1px solid #8440e0c4;
}
figure.snip1249:after {
...
figure.snip1249.hover:after {
 ...
 .text-block {
   ...
   <body>
    ...
    <p style="margin: 20px;font-weight: 300;font-size: 81px;line-height: 62px;">Fashion & Beauty <br> <center style="font-size: 81px;position: relative;
    bottom: 53px;">products</center></p>
    </div>
    </div>
     </div>
...
<%@page import="java.sql.Connection"%>
  ...
  <div class="image">
    <img src="admin/src/main/webapp/images/products/chudi.jpg" alt="sample90"/><i class="fa fa-heart-o"></i>
  </div>
  <figcaption>
    <h3>Shoes</h3>
<!--     <p>How many boards would the Mongols hoard if the Mongol hordes got bored?</p>
 ...
 <div class="price">
    ...
    <a href="buy.jsp" class="add-to-cart">Buy Now</a><br><br>
...
<figure class="snip1249 hover">
  <div class="image">
    <img src="images/shirts.jpg" alt="sample85"/><i class="fa fa-heart-o"></i>
  </div>
  <figcaption>
    <h3>Shirt</h3>
<!--     <p>I'm killing time while I wait for life to shower me with meaning and happiness.</p>
 -->    
   ...
   <a href="#" class="add-to-cart">Buy Now</a><br><br>
    <a href="#" class="add-to-cart">Add to Cart</a>
  </figcaption>
</figure>
</div>
...
<figure class="snip1249">
  <div class="image">
    <img src="images/chudi.jpg" alt="sample71"/><i class="fa fa-heart-o"></i>
  </div>
  <figcaption>
    <h3>Chudidhar</h3>
...
<figure class="snip1249">
  <div class="image">
    <img src="images/jeans.webp" alt="sample71"/><i class="fa fa-heart-o"></i>
  </div>
  <figcaption>
    <h3>Jeans Pant</h3>
<!--     <p>Weekends don't count unless spent doing something completely pointless.</p>
...
<figure class="snip1249">
  <div class="image">
    <img src="images/sarie.jpg" alt="sample71"/><i class="fa fa-heart-o"></i>
  </div>
  <figcaption>
    <h3>sarie</h3>
<!--     <p>Weekends don't count unless spent doing something completely pointless.</p>
...
<figure class="snip1249">
  <div class="image">
    <img src="images/frock.png" alt="sample71"/><i class="fa fa-heart-o"></i>
  </div>
  <figcaption>
    <h3>Frock</h3>
<!--     <p>Weekends don't count unless spent doing something completely pointless.</p>
...
<figure class="snip1249">
  <div class="image">
    <img src="images/tshirt.webp" alt="sample71"/><i class="fa fa-heart-o"></i>
  </div>
  <figcaption>
    <h3>Boys T - shirt</h3>
<!--     <p>Weekends don't count unless spent doing something completely pointless.</p>
...
<figure class="snip1249">
  <div class="image">
    <img src="images/girl_tshirt.webp" alt="sample71"/><i class="fa fa-heart-o"></i>
  </div>
  <figcaption>
    <h3>Girls T - shirt</h3>
<!--     <p>Weekends don't count unless spent doing something completely pointless.</p>
