            ...
            <div class="container-fluid mt-3">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6">
                       ...
                       <a href="./fashion_table.jsp">
                        <div class="card gradient-2">
                            <div class="card-body" style="height:173px">
                               <!--  <h3 class="card-title text-white">Fashion</h3> -->
                                <div class="d-inline-block">
                    ...
                    <div class="col-lg-3 col-sm-6">
                     ...
                     <a href="./grocery_table.jsp">
                        <div class="card gradient-3">
                            <div class="card-body" style="height:173px">
                               <!--  <h3 class="card-title text-white">Groceries</h3> -->
                                <div class="d-inline-block">
                                    <h2 class="text-white">Groceries</h2>
                                  <!--   <p class="text-white mb-0">Jan - March 2019</p> -->
                                </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                    <a href="./electronics_table.jsp">
                        <div class="card gradient-4">
                            <div class="card-body" style="height:173px">
                               <!--  <h3 class="card-title text-white">Customer Satisfaction</h3> -->
                                <div class="d-inline-block">
                                    <h2 class="text-white">Mobiles &</h2>
                    ...
                    <a href="./furniture_table.jsp">
                        <div class="card gradient-4">
                            <div class="card-body" style="height:173px">
                               <!--  <h3 class="card-title text-white">Customer Satisfaction</h3> -->
                                <div class="d-inline-block">
                                    <h2 class="text-white">Furniture &</h2>
                                    <h2 class="text-white">Appliances</h2>
                                   <!--  <p class="text-white mb-0">Jan - March 2019</p> -->
                                </div>
                                <span class="float-right display-5 opacity-5"><i class="fa fa-heart"></i></span>
                            </div>
                     ...
                     <div class="col-lg-3 col-sm-6">
                      ...
                      <a href="./health_table.jsp">
                        <div class="card gradient-3">
                            <div class="card-body" style="height:173px">
                               <!--  <h3 class="card-title text-white">Groceries</h3> -->
                                <div class="d-inline-block">
                                    <h2 class="text-white">Health Care &</h2>
                                     <h2 class="text-white">Personal Care</h2>
                                  <!--   <p class="text-white mb-0">Jan - March 2019</p> -->
                                </div>
                                <span class="float-right display-5 opacity-5"><i class="fa fa-users"></i></span>
                            </div>
                     ...
                     <div class="col-lg-3 col-sm-6">
                       ...
                       <a href="./gift_table.jsp">
                        <div class="card gradient-2">
                            <div class="card-body" style="height:173px">
                               <!--  <h3 class="card-title text-white">Fashion</h3> -->
                                <div class="d-inline-block">
                                    <h2 class="text-white">Gifting</h2>
                                   <!--  <p class="text-white mb-0">Jan - March 2019</p> -->
                                </div>
                                <span class="float-right display-5 opacity-5"><i class="fa fa-money"></i></span>
                            </div>
                     ...
                     <div class="col-lg-3 col-sm-6">
                     <a href="./sports_table.jsp">
                     
                        <div class="card gradient-1">
                            <div class="card-body" style="height:173px">
                           <!--      <h3 class="card-title text-white">Books &</h3> -->
                                <div class="d-inline-block">
                                    <h2 class="text-white">Sports, Outdoor</h2>
