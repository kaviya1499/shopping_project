...
@MultipartConfig
@WebServlet("/fashion_insert")
public class fashion_insert extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public fashion_insert() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try 
		{
			...
			String query="insert into fashion(name,price,discription,image) values(?,?,?,?)";
			...
			{
				  response.sendRedirect("fashion_form.jsp");
			}
